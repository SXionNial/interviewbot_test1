...
class FileUploadForm(forms.ModelForm):
    account = forms.CharField(widget=forms.TextInput(attrs={'id':'account_id','placeholder':''}),required=True)
    file = forms.FileField(widget=forms.TextInput(attrs={'id':'file','placeholder': 'file*'}),required=True)
    phone = forms.CharField(widget=forms.TextInput(attrs={'id':'phone','placeholder':''}),required=True)
    email = forms.CharField(widget=forms.TextInput(attrs={'id':'email','placeholder':''}),required=True)
    address = forms.CharField(widget=forms.TextInput(attrs={'id':'address','placeholder':''}),required=True)
    job_objectives = forms.CharField(widget=forms.TextInput(attrs={'id':'job_objectives','placeholder':''}),required=True)
    bdate = forms.DateField(widget=forms.TextInput(attrs={'id':'bdate','placeholder':''}),required=True)
    class Meta:  
